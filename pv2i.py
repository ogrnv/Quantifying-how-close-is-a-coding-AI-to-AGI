...
'''
Please change TTSR function in the following python program pv2.py to achieve the best test results i.e minimal number of moves in all tests of pv2.py: python3 pv2.py ...
See the definitions of moves, test... below in the pv2.py program.
